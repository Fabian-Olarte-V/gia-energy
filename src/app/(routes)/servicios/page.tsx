...
function ServicesContent() {
    ...
    const validTypes = ["energia-solar", "eficiencia", "almacenamiento", "todos"];
    ...
    return (
        <div className="services-page__container container">
            ...
            <div
                className={`services-page__image-container${normalizedTipo === "eficiencia" ? " services-page__image-container--large" : ""}`}
                style={{ backgroundImage: `url(${backgroundImage})` }}
            />
            <ServicesSection initialData={ServicesData} categoryType={tipo} />
        </div>
    );
}
